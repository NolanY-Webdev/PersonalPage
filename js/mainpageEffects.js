...
if (document.images) {
  ...
  $('.projectsTab').click(function(){
    ...
    if(currentTab!='projectsContainer' && !animating){
      ...
      $('.projectDisplay').html(
        '<p class="projTextBox"><-- Select one of my amazing works <br> If the animations look messy its because all the images haven\'t had the chance to load yet. It\'s not my page\'s fault, those are set to preload. Ok, ok, I\'ll get right on fixing the slow internet, after all I\'m an <a href="#" onclick="window.open(\'https://www.youtube.com/watch?v=BKorP55Aqvg\',\'_blank\')">expert</a> right?.  <br>(Unfortunately old projects built/hosted on free Meteor servers have been removed due to a <a title=":(" href="#" onclick="window.open(\'https://forums.meteor.com/t/meteor-com-free-hosting-ends-march-25-2016/19308\',\'_blank\')">change in Meteor policies</a>) <br> <br> Or admire this ancient project from when I was beginning to learn code. A very basic application typically called pixel painter or something along those lines. Not really worth its own tab, but it looks pretty. --></p>'
        );
...
function randomAbtMe() {
  var aboutMes = [
    ...
    'O_o Who viewed my website in Paris? I should warn you: "Ju suis un pizza, avec du fromage"'
